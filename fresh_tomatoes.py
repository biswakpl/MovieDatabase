...
main_page_content = '''
  <body>
    ...
    <!-- Main Page Content -->
    <div class="container">
      <div class="navbar navbar-inverse navbar-fixed-top" role="navigation" id="top-bar">

        <div class="container">
          <div class="navbar-header">
            <a class="navbar-brand" href="#">Best Romantic Movies</a>
          </div>
        </div>
      </div>
    </div>
...
def create_movie_tiles_content(movies):
    ...
    for movie in movies:
        ...
        content += movie_tile_content.format(
            ...
            poster_image_url=movie.logo_url,
